        ...
        <div class="container-contact1">
            <div class="row justify-content-center align-self-center">
                <div class="col-sm-6 col-sm-offset-3">
                    <img src="images/gagal.png" class="h-40 w-25">
                    <h3>Pesanan Gagal Di Proses</h3>
                    <br/>
                    <p style="font-size:20px;color:#5C5C5C;">Kami tidak dapat menerima <?=htmlspecialchars($jumlahBarang);?> unit <?=htmlspecialchars($namaBarang);?> pesanan anda, silahkan coba lagi, Kembali ke menu?</p>
